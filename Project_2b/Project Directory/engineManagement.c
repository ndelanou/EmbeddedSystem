...
void SetPosition(Engine* e, int position) {
	switch (position) {
		case 0 : e->upTime.tv_nsec = POSITION_0;
		break;
		case 1 : e->upTime.tv_nsec = POSITION_1;
		break;
		case 2 : e->upTime.tv_nsec = POSITION_2;
		break;
		case 3 : e->upTime.tv_nsec = POSITION_3;
		break;
		case 4 : e->upTime.tv_nsec = POSITION_4;
		break;
		case 5 : e->upTime.tv_nsec = POSITION_5;
		break;
		default: break;
	}
}
...
/*
	Make the engine go right if possible
*/
